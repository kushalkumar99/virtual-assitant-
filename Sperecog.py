...
def wishMe():
      ...
      speak("I am kristel. you can call me kristy. I'm busy right now. my assistant will assist you")  
...
def respond(voice_data):
    ...
    if there_exists(["what is your name","what's your name","tell me your name"]):
        if person_obj.name:
            ...
            engine_speak("my name is stanfia. kristy's assistant")
